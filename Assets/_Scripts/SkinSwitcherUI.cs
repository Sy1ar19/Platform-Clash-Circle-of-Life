...
public class SkinSwitcherUI : MonoBehaviour
{
    ...
    public void HandleActionButton(Skin[] info, int index, PlayerMoney playerMoney, bool[] stockCheck)
    {
        PlayButtonClickSound();

        if (!info[index].inStock)
        {
            int skinCost = info[index].cost;
